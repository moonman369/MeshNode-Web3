...
contract Stack3Badges is ERC1155, Ownable {
    ...
    uint256 public constant QUESTION_100 = 1;
    uint256 public constant QUESTION_500 = 2;
    uint256 public constant QUESTION_1000 = 3;

    uint256 public constant ANSWER_100 = 4;
    uint256 public constant ANSWER_500 = 5;
    uint256 public constant ANSWER_1000 = 6;

    uint256 public constant BEST_ANSWER_10 = 7;
    uint256 public constant BEST_ANSWER_50 = 8;
    uint256 public constant BEST_ANSWER_100 = 9;

    uint256 public constant COMMENTS_50 = 10;
    uint256 public constant COMMENTS_250 = 11;
    uint256 public constant COMMENTS_500 = 12;

    uint256 public constant UPVOTE_QUESTION_200 = 13;
    uint256 public constant UPVOTE_QUESTION_600 = 14;
    uint256 public constant UPVOTE_QUESTION_1200 = 15;

    uint256 public constant UPVOTE_ANSWER_200 = 16;
    uint256 public constant UPVOTE_ANSWER_600 = 17;
    uint256 public constant UPVOTE_ANSWER_1200 = 18;
    ...
    function updateAndRewardBadges (uint8 _reqType, uint256 _numPost, address _user) external {
        ...
        if (_reqType == 0) {
            ...
            if (_numPost == 100) { // Q posts
                _mint(_user, QUESTION_100, 1, "");
            }
            else if (_numPost == 500) {
                _mint(_user, QUESTION_500, 1, "");
            }
            else if (_numPost == 1000) {
                _mint(_user, QUESTION_1000, 1, "");
            }
        }

        else if (_reqType == 1) { // Q vote
            if (_numPost == 200) {
                _mint(_user, UPVOTE_QUESTION_200, 1, "");
            }
            else if (_numPost == 600) {
                _mint(_user, UPVOTE_QUESTION_600, 1, "");
            }
            else if (_numPost == 1200) {
                _mint(_user, UPVOTE_QUESTION_1200, 1, "");
            }
        }
            ...
            if (_numPost == 200) {
                ...
                _mint(_user, UPVOTE_ANSWER_600, 1, "");
            }
            else if (_numPost == 1200) {
                _mint(_user, UPVOTE_ANSWER_1200, 1, "");
            }
        }
            ...
            if (_numPost == 50) {
                _mint(_user, COMMENTS_50, 1, "");
            }
            else if (_numPost == 250) {
                _mint(_user, COMMENTS_250, 1, "");
            }
            else if (_numPost == 500) {
